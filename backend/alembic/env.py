...
# import triggers model registration onto Base.metadata; without it autogenerate sees no tables
from ninecat import models  # noqa: F401
...
def get_url() -> str:
    # database url comes from Settings (process env / repo-root .env), not
